...
class Posts:
    def __init__(self, isSafe, Tags, Limit, Page, Check):
        self.Tags = Tags
        self.isSafe = isSafe
        self.Limit = Limit
        self.Page = Page
    ...
    def getPost(self, isSafe, PostID):
        RequestLink = "https://e"
    ...
    def getPosts(self):
        ...
        RequestLink += "limit="
        RequestLink += str(self.Limit)

        # Specifies the page
        RequestLink += "&page="
        RequestLink += str(self.Page)
...
class Pool:
    def __init__(self, isSafe, PoolID):
        self.isSafe = isSafe
        self.PoolID = PoolID
    ...
    def getPool(self):
        ...
        RequestLink += "?&search[id]=" + str(self.PoolID)
    ...
    def getPoolPosts(self):
        # Get ID of all posts in a pool
        poolPosts = self.getPool()["post_ids"]
        ...
        for postID in poolPosts:
            ...
            posts.append(Posts.getPost(self, self.isSafe, postID))
